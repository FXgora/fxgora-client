...
const BurnModal = ({
  ...
  return (
    ...
    >
      ...
      Please make sure this action is deliberate and you fully understand the consequences as FXgora will not be held responsible for the loss of NFTs under any circumstances.
      </div>
