              ...
              try {
                ...
                try {
                  ...
                  signature = await signer.signMessage(
                    `Approve Signature on FXgora.io with nonce ${nonce}`
                  );
                } catch (err) {
                  toast(
                    'error',
        ...
        <div className="col-lg-4 col-md-8 space-y-20">
          ...
          <FormGroup>
            ...
            <FormControlLabel
              ...
              label="I accept FXgora's Terms and Conditions. *"
              className="align-items-start"
            />
          </FormGroup>
        </div>
          ...
          {isRegister && (
            <div className={styles.inputGroup}>
              <div className={styles.inputTitle}>
                Royalty *&nbsp;
                <BootstrapTooltip
                  title="Each NFT under this collection exchanged through FXgora will have a percentage of sale given to nominated wallet address."
                  placement="top"
                >
                  <HelpOutlineIcon />
                </BootstrapTooltip>
