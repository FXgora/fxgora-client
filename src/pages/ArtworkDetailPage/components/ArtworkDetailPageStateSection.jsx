    ...
    >
      <div className={cx('ml-10 space-y-10')}>
        {(!owner && !tokenType.current) &&
          <div className={`${styles.itemOwner} text-danger`}><WarningIcon className={styles.itemIcon} c /> This item is not listed on FXgora (Still syncing, Burned, or Banned)</div>
